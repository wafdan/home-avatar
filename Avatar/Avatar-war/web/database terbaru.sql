...
('customer', 'Andara Livia', '91ec1f9324753048c0096d036a694f86', 'e.k_moe@yahoo.com', 'Passport', 'C567456', 'Jl. Terusan Dago Pojok', NULL, 'Bandung', 'Indonesia', NULL),
...
(3, 'F0002', 1, 'Oxtail Soup + Rice. Mango Juice'),
(4, 'F0001', 1, 'Fried Rice, Orange Juice. Deliver before 6am tomorrow'),
(5, 'M0001', 1, ''),
(8, 'C0001', 1, ''),
(13, 'F0001', 1, ''),
(14, 'F0001', 1, ''),
...
(1, 'Hotel Graha', 'Jl. Ir. Hi. Djuanda 45', 'Kecamatan Coblong, Kelurahan Dago', 'Bandung', 'Indonesia', 'graha@hotel.co.id', 'Welcome to Hotel Graha Bandung, a five star luxury hotel in Bandung, West Java. Located in the heart of Bandung, we provide a superior level of service to satisfy the needs of our global guests. As a member of the "Hotel Graha" group, the Hotel Graha Bandung offers an extraordinary level of service and coordinated interior designs. Restored to its original opulence, Hotel Graha Bandung sets the standard for elegance. From the magnificent columned lobby with its marble floors and stained-glass dome to the classic décor of the 250 guestrooms and suites, we ensures that every stay is a memorable one.', 'images/demo/logohotel.png', '+6222 786567', '+6222 786568', '0129903495', 'BNI', 'Hotel Graha Bandung', '12338838', 'BCA', 'Hotel Graha Bandung', 5);
