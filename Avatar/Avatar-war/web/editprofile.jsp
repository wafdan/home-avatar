                    ...
                    <div id="wrap">
                        <form id="form_20674" class="appnitro"  method="post" action="">
                            ...
                            <ul id="list_field">
                                ...
                                <li id="li_2" >
                                    <label class="description" for="element_2">ID Type </label>
                                    <div>
                                        <select id="element_2" name="element_2" class="element select medium">
                                            <option value="Afghanistan" >Citizen ID</option>
                                            <option value="Albania" >Passport</option>
                                            <option value="Algeria" >Driving License</option>
                                        </select>
                                    </div>
                                </li>

                                <li id="li_3" >
                                    <label class="description" for="element_3">ID Number </label>
                                    <div>
