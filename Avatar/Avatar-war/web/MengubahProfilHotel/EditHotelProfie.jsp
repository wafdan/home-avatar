    ...
    <body>
        ...
        <div id="page">
            <div id="page-bgtop">
                <div id="centerside">
                    <div id="wrap">
                        <form id="form_20674" class="appnitro"  method="post" action="">
                            ...
                            <ul id="list_field">
                                <li id="li_1" >
                                    ...
                                    <div>
                                        <input id="element_1" name="hotelname" class="element text medium" type="text" maxlength="255" value=""/>
                                    </div>
                                </li>

                                <li id="li_2" >
                                    <label class="description" for="element_1">Hotel Description </label>
                                    <div>
                                        <input id="element_2" name="hotedesc" class="element text medium" type="textarea" maxlength="255" value=""/>
                                    </div>
                                </li>

                                <li id="li_3" >
                                    <label class="description" for="element_3">Hotel Logo Directory</label>
                                    <div>
                                        <input id="element_3" name="imagedirectory" class="element text medium" type="text" maxlength="255" value=""/>
                                    </div>
                                </li>
                                ...
                                <li id="li_6" >
                                    ...
                                    <div>
                                        <input id="element_6_1" name="address" class="element text large" value="" type="text" />
                                        <label for="element_6_1">Street Address</label>
                                    </div>

                                    <div>
                                        <input id="element_6_2" name="address2" class="element text large" value="" type="text" />
                                        <label for="element_6_2">Address Line 2</label>
                                    </div>

                                    <div class="left">
                                        <input id="element_6_3" name="city" class="element text medium" value="" type="text" />
                                        <label for="element_6_3">City</label>
                                    </div>

                                    <div class="right">
                                        <input id="element_6_4" name="state" class="element text medium" value="" type="text" />
                                        <label for="element_6_4">State / Province / Region</label>
                                    </div>

                                    <div class="left">
                                        <input id="element_6_5" name="zipcode" class="element text medium" maxlength="15" value="" type="text" />
