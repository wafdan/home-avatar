    ...
    <body>
        ...
        <div id="page">
            <div id="page-bgtop">
                <div id="centerside">
                    <div id="wrap">
                        <form id="form_20674" class="appnitro"  method="post" action="/MengubahProfilHotel/EditProfilHotel">
                            ...
                            <ul id="list_field">
                                ...
                                <li id="li_6" >
                                    ...
                                    <div class="left">
                                        ...
                                        <div class="right">
                                            <select class="element select medium" id="element_6_6" name="country">
