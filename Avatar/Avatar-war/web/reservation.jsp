...
<html>
    ...
    <body>
        ...
        <form action="AddFacility" method="POST">
            ...
            <!-- BAGIAN DHANA -->
            <label>Check-in date</label> <input name="roomcheckindate" type="text" class="datepicker" />
            ...
            <label>Total hall needed</label> <input type="text" name="totalhall" class="datepicker"/>
            <!-- BAGIAN DHANA LAGI -->
