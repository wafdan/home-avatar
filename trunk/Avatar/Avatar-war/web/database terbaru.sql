...
--
-- Host: localhost
-- Generation Time: Nov 16, 2010 at 12:15 AM
...
('christian.h6191', 'Christian Hadiwinoto', '2345f10bb948c5665ef91f6773b3e455', 'if17081@students.if.itb.ac.id', 'Passport', 'V608081', 'Jalan Sultan Tirtayasa 43', NULL, 'Bandung', 'Indonesia', '+6281806115607'),
...
(3, 'HL002', '08:00:00', '18:00:00', '2010-11-30', 50, NULL);
...
(4, 2, '2010-11-15 21:42:34', 'admin', '2010-10-23', 'cash', 'BRI', '000011223331', 30595000);
...
CREATE TABLE IF NOT EXISTS `profile` (
  ...
  `paylimit_constant` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `profile` (`id`, `hotel_name`, `hotel_address1`, `hotel_address2`, `hotel_city`, `hotel_country`, `hotel_email`, `hotel_description`, `hotel_logo`, `hotel_phone`, `hotel_fax`, `account_number1`, `bank_name1`, `account_name1`, `account_number2`, `bank_name2`, `account_name2`, `paylimit_constant`) VALUES
(1, 'Hotel Grao', 'Jalan Spons 112', 'Kelurahan Ceu Kecamatan Ceuceu', 'Jakarta', '', 'contact@sponshotel.co.id', 'Hotel ini berada di kawasan elit jakarta, terbebas dari semrawut dan kemacetan kota Jakarta', NULL, '085220280021', '', '', '', '', NULL, NULL, NULL, 1);
...
(3, 2, '2010-10-22 09:37:01', 30000000, 'H'),
(4, 2, '2010-11-01 10:00:00', 50000, 'O'),
(5, 3, '2010-11-15 15:00:02', 545000, 'R');
...
(5, '102', '2010-11-19', '2010-11-20', NULL, NULL);
