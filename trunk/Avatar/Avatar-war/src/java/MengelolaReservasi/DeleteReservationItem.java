 ...
 * @author Christian
 */
public class DeleteReservationItem extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            rijpa.destroy(Integer.parseInt(request.getParameter("item")));
            response.sendRedirect("reservation_manage.jsp");
        } catch (NonexistentEntityException ex) {
            Logger.getLogger(DeleteReservationItem.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    } 
